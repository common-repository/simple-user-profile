...
Plugin URI: 
Description: Select which inputs to remove from the user profile.  You can remove all options except Username, email, and password in User>Simplify Profile by checking the options you don't want displayed.  This can also be applied to a front end page for plugins such as the theme my login plugin.
